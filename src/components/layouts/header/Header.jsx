...
import { clearDataByKey, selectUserData } from "../../../redux/reducers/user";
...
const Header = () => {
  ...
  const handleLogout = () => {
    dispatch(clearDataByKey("user"));
    dispatch(clearDataByKey("token"));
    Swal.fire({
      position: "top-end",
      icon: "success",
        ...
        <li class="dropdown notification-list">
          ...
          >
            ...
            <span class="pro-user-name ml-1">
              {userData?.user?.username} <i class="mdi mdi-chevron-down"></i>
            </span>
          </a>
          <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
            ...
            <a href="javascript:void(0);" class="dropdown-item notify-item">
              ...
              <span>
                My Wallet <span class="badge badge-success float-right">3</span>{" "}
              </span>
            </a>
            ...
            <a href="javascript:void(0);" class="dropdown-item notify-item"  onClick={handleLogout}>
